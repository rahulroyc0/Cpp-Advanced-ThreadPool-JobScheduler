...
A high-performance, thread-safe asynchronous task scheduler written in Modern C++ (C++11/14/17). This system features a custom ThreadPool implementation coupled with a Priority-based Job Scheduler, capable of handling one-off, delayed, and recurring tasks with generic return types.
...
This is a lightweight implementation. Simply include the header files in your project.

```bash
# Clone the repository
git clone [https://github.com/YOUR_USERNAME/Cpp-Advanced-ThreadPool-JobScheduler.git](https://github.com/YOUR_USERNAME/Cpp-Advanced-ThreadPool-JobScheduler.git)

# Compile (Example)
g++ -O3 -pthread -I./includes main.cpp src/ThreadPool.cpp src/JobScheduler.cpp -o app
=======
# Key Features
...
<img width="1920" height="1080" alt="Screenshot (121)" src="https://github.com/user-attachments/assets/c54f6eb3-f12b-4f49-a597-2fa0f0bb689c" />
>>>>>>> bb6eb6676441923686997bc2a13e420df479a7e6
